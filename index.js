...
document.addEventListener('keydown', function(event, element) {

    const keyPressed = event.key;
    const codePressed = event.code;

    if(element = document.querySelector(`[data-letter="${keyPressed}"]`)){ 
         element.classList.add('pressed');
     } else
    if(element = document.querySelector(`[data-letter="${codePressed}"]`)){ 
         element.classList.add('pressed');
     } 

  });
document.addEventListener('keyup', function(event, element) {
